...
using Hexalith.MyNewModules.Application.Services;
using Hexalith.MyNewModules.DocumentContainers;
using Hexalith.MyNewModules.MyNewModule;
using Hexalith.MyNewModules.MyNewModuletorages;
using Hexalith.MyNewModules.Requests.DocumentContainers;
using Hexalith.MyNewModules.Requests.MyNewModule;
using Hexalith.MyNewModules.Requests.MyNewModuletorages;
using Hexalith.MyNewModules.ValueObjects;

// <copyright file="MyToDoAddedValidator.cs" company="ITANEO">
...
/// <summary>
/// Validator for MyToDoAdded event.
/// </summary>
public class MyToDoAddedValidator : AbstractValidator<MyToDoAdded>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MyToDoAddedValidator"/> class.
    /// </summary>
    /// <param name="localizer">The localizer for validation messages.</param>
    public MyToDoAddedValidator(IStringLocalizer<Labels> localizer)
    {
